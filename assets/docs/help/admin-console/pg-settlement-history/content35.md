...
> PG 정산내역 서비스에서는 포트원을 통해 연동된 아래 17개의 PG사 내역을 조회할 수 있습니다.

- KCP, KG이니시스, 나이스정보통신, 토스페이, 네이버페이, 다날, 페이코, UPLUS((구)토스페이먼츠), 토스페이먼츠, 카카오페이, 엑심베이, 헥토파이낸셜, KSNET, KPN, 페이팔, KG파이낸셜, 페이레터
