...
<Callout content="- 다날 SMS 본인인증은 PG사 정책상 **테스트환경 지원이 불가**하여 실제 PG사와 계약을 맺으신 후 실제 연동 KEY로 연동 테스트가 가능합니다.
- NHNKCP 소켓(API) 방식 본인인증은 포트원을 통해 NHN KCP와 사전 협의가 필요한 사항입니다. 신청 전 포트원으로 먼저 문의해 주시기 바랍니다." title="참고사항" icon="💡" />
