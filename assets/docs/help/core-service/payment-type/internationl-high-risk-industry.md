...
- 일본 특정상거래법에 의거한 표시사항 및 일본
  개인정보보호 방침 기재 필수\
  Sample 참고 : <https://www.waug.com/ja>
...
**이 외 추가로 원천사 또는 KICC의 심사 기준에 따라 위험 업종으로 판단될 경우 입점이 제한되거나 불가할 수 있습니다.**

<Callout title="이지페이 해외결제 서비스 안내 보러가기 ↗" />
