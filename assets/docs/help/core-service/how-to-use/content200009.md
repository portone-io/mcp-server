...
<Callout content="워드프레스 우커머스 플러그인을 통해 웹사이트를 구축하시는 경우, 
이용 가능한 결제대행사와 연동 방식이 구분되어 있으니 참고하시어 이용해 주시기 바랍니다." />
...
- KG이니시스 : 신용카드, 휴대폰 소액결제, 실시간 계좌이체, 가상계좌
...
- 헥토파이낸셜 : 신용카드
- KSNET신용카드, 휴대폰 소액결제, 실시간계좌이체, 가상계좌
