---
title: KG파이낸셜 상세 계약절차
category: 결제서비스 (채널설정 및 이용안내) > 이용안내 > 결제대행사 계약
seo:
  title: KG파이낸셜 상세 계약절차
  description: >-
    KG파이낸셜의 전자결제 계약절차는 가입신청서 제출 - 계약안내 - 계약진행 - 계약완료 - 포트원 관리자콘솔 채널설정 - 개발진행 -
...
<Callout content="" title="KG파이낸셜과 계약을 맺으시기 위한 절차를 순서대로 알려드립니다." />

### **가입신청서 제출**

[포트원 관리자콘솔↗](https://admin.portone.io/) 안에서 KG파이낸셜의 가입신청서를 제출합니다.
...
<Callout title="참고사항" icon="💡" content="현재 KG파이낸셜은 신용카드, 휴대폰결제 연동 서비스만 이용 가능합니다." />



### **KG파이낸셜의 계약 안내**

- 포트원으로 접수해 주신 신청건은 당사에서 1차 검수 후 KG파이낸셜로 전달되며,
- 가입 신청서를 제출해 주신 이후 2\~3영업일 내 KG파이낸셜 계약부서로부터 자세한 안내를 받습니다.
...
- KG파이낸셜 설정 방법은 아래 가이드를 통해 자세히 확인해주시기 바랍니다.

<Callout icon="" title="KG파이낸셜 채널설정방법 보러가기 ↗" />
