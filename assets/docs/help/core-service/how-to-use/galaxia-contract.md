...
<Callout content="" title="갤럭시아머니트리와 계약을 맺으시기 위한 절차를 순서대로 알려드립니다." />

### **가입신청서 제출**

[포트원 관리자콘솔↗](https://admin.portone.io/) 안에서 갤럭시아머니트리의 가입신청서를 제출합니다.
...
- 포트원으로 접수해 주신 신청건은 당사에서 1차 검수 후 갤럭시아 머니트리로 전달되며,\
  가입 신청서를 제출해 주신 이후 2\~3영업일 내 갤럭시아 머니트리 계약부서로부터 자세한 안내를 받습니다.
...
<Callout icon="" title="갤럭시아머니트리 채널설정방법 보러가기 ↗" />
