...
- 포트원 관리자콘솔 채널설정 : 계약 후 담당자 메일로 안내 받은 사이트코드로 채널 설정
  - 카드사 심사 진행 방법 : NHNKCP 파트너센터(<https://partner.kcp.co.kr>) > 상점정보관리 > 카드사심사 등록현황 > 카드심사 등록신청
...
포트원 관리자콘솔 에서 NHN KCP의 실연동 사이트코드를 설정합니다.\
