...
- 채널 속성 : 결제
- PG상점아이디 (MID) 클릭
  - 결제창 일반결제 CF3309AD19 선택
  - 결제창 정기결제 32AAE5BE9B 선택
  - 결제창 국내 일반결제 35D49A8CAA 선택
- 과세설정 : [포트원 PG 거래대사서비스↗ ](https://help.portone.io/category/admin-console/pg-settlement)이용시 단순 과세계산을 위해 사용되는 항목으로 미 이용시 설정하지 않으셔도 무방합니다. 거래의 과세/면세 여부와는 관계없습니다.

<Accordion title="엑심베이 테스트 카드 정보 확인 ▼" content="<>
  ##### **VISA**
  ...
  * **Frictionless**
  * 카드번호 : 5310 1111 1111 1111
  * 유효기간 : 12/33
  * CVC :  123
  * **Challenge**
  * 카드번호 : 5122 9699 9999 9996
  * 유효기간 : 12/33
  * CVC :  123&#x9;
  * 인증번호 : 111
  ...
  * **Frictionless**
  * 카드번호 : 3562 7370 4605 7080
  * 유효기간 : 12/33
  * CVC : 123
  * **Challenge**
  * 카드번호 : 3569 9900 1229 6085
  * 유효기간 : 12/33
  * CVC :  123&#x9;
  * 인증번호 : 111
  ...
  * **Frictionless**
  * 카드번호 : 3759 8700 0126 600
  * 유효기간 : 12/33
  * CVC : 123
  * **Challenge**
  * 카드번호 : 3759 8700 0126 700
  * 유효기간 : 12/33
  * CVC :  123&#x9;
  * 인증번호 : 111
  ...
  * 카드번호 : 3607 0500 0010 38
  * 유효기간 : 12/33
  * CVC : 234
  
  ##### **Discover**
  
  * 카드번호 : 6510 0000 0000 0174
  * 유효기간 : 12/33
  * CVC : 234
  * 인증번호
  * PC : 1111111
...
- 포트원 내부에서는 pay\_method : vbank 로 기록됨 \* Econtext 등록이
  완료되었다는 콜백함수 및 웹훅 전송 (status : ready 상태 / vbank\_num 은
  unknown 으로 고정) \* Econtext 로부터 입금확인이 되면 포트원에서 엑심베이로부터
  응답을 받아 status : paid 로 변경 후 결제완료처리에 대한 웹훅 전송
...
- 엑심베이 테스트모드 ON상태에서 결제창 호출 진행 \* 콜백 응답 중 pg\_tid 값을
  별도로 메모 (포트원관리자페이지상에서는 PG사승인번호 컬럼에서 확인 가능) \*
  [엑심베이 테스트 화면 ↗](https://form.int.econ.ne.jp/paynotice "테스트") 로
  이동 후 계정 로그인 \ (아이디 : ectest / 비번 : #Gwecn25 )

</Indent>

<Indent level="2">

- ShopID : 361301, orderID : PG사승인번호 입력 \* 하단에 있는  登録 버튼 클릭 \*
  다음 페이지에서 한 번 더  登録 클릭 \* 10분 후 결제상태가 status : paid 로
  바뀌는지 확인 ( 이 때 입금에 대한 웹훅 발송됨 )
